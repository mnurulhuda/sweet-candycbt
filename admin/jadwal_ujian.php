...
?>
                    ...
                    <div class='form-group'>
                        <label></label><br>
                        <label>
                            <input type='checkbox' class='icheckbox_square-green' name='acak' value='1' $acak /> Acak
                            Soal
                        </label>

                        <label>
                            <input type='checkbox' class='icheckbox_square-green' name='token' value='1' $token /> Token
                            Soal
                        </label>

                        <label>
                            <input type='checkbox' class='icheckbox_square-green' name='hasil' value='1' $hasil /> Hasil
                            Tampil
                        </label>
                    </div>
                    <div class='modal-footer'>
                        <button name='tambahjadwal' class='btn btn-sm btn-flat btn-success'><i class='fa fa-check'></i>
                            Simpan Semua</button>
                    </div>
                </form>
            </div>
        ...
        <div class='box box-solid'>
            <div class='box-header with-border '>
                ...
                <div class='box-tools pull-right '>
                    ...
                    <button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-backdrop='static'
                    ...
                    <form id='formaktivasi' action="">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ujian[]" style="width:100%" multiple='true'
                                ...
                                <option value="<?=$ujian['id_ujian']?>"><?=$ujian['nama'] . "-" . $ujian['id_pk']?>
                                </option>
                                <?php endwhile;?>
                            </select>
                        </div>
                    ...
                    <ul class="nav nav-stacked">
                        ...
                        <li>
                            <a href="#">
                                ...
                                <span class="pull-right badge bg-purple"><?=$mapel['tampil_pg']?> Soal /
                                    <?=$mapel['lama_ujian']?> menit</span>
                            </a>
                        </li>
...
?>
                    ...
                    <center style="padding: 8px">
                        <a class="btn btn-primary " href="?pg=nilai&id=<?=$mapel['id_ujian']?>"><i
                                class="fa fa-hand-peace "></i> Nilai</a>
                        <a class="btn btn-primary " href="?pg=status&id=<?=$mapel['id_ujian']?>"><i
                                class="fa fa-binoculars "></i> Status</a>
                        <a class="btn btn-primary " href="?pg=banksoal&ac=lihat&id=<?=$mapel['id_mapel']?>"><i
                                class="fa fa-search "></i> Soal</a>
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#modelId<?=$mapel['id_ujian']?>">
                    ...
                    <form id="formedit<?=$mapel['id_ujian']?>">
                        <div class='modal-body'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="tgl form-control" name="mulaiujian"
                                    value="<?=$mapel['tgl_ujian']?>" aria-describedby="helpId" placeholder="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="tgl form-control" name="selesaiujian"
                                    value="<?=$mapel['tgl_selesai']?>" aria-describedby="helpId" placeholder="">
                            ...
                            <div class='form-group'>
                                <div class='row'>
                                    <div class='col-md-6'>
                                        ...
                                        <input type='number' name='lama_ujian' value="<?=$mapel['lama_ujian']?>"
                                            class='form-control' required='true' />
                                    </div>
                                    <div class='col-md-6'>
                                        <label>Sesi</label>
                                        <input type='number' name='sesi' value="<?=$mapel['sesi']?>"
                                            class='form-control' required='true' />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class='modal-footer'>
                            ...
                            <center>
                                <button type="submit" class='btn btn-primary' name='simpan'><i class='fa fa-save'></i>
                                    Ganti Waktu Ujian</button>
                            </center>
